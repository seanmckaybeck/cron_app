...
class CronForm(Form):
    ...
    '''
    minute = StringField('Minutes (0-59 or *):',
                              validators=[Required(),
                                          is_valid_input(minimum=0,
                                          maximum=59)])
    hour = StringField('Hours (0-23 or *):', validators=[Required(),
                            is_valid_input(minimum=0, maximum=23)])
    day = StringField('Day (1-30 or *):', validators=[Required(),
                           is_valid_input(minimum=1, maximum=30)])
    month = SelectField(u'Month', choices=[('*', 'All'), ('1', 'Jan'),
                             ('2', 'Feb'), ('3', 'Mar'), ('4', 'Apr'),
                             ('5', 'May'), ('6', 'Jun'), ('7', 'Jul'),
                             ('8', 'Aug'), ('9', 'Sep'), ('10', 'Oct'),
                             ('11', 'Nov'), ('12', 'Dec')],
                             validators=[Required()])
    weekday = SelectField(u'Weekday', choices=[('*', 'All'),
                               ('0', 'Sun'), ('1', 'Mon'), ('2', 'Tue'),
                               ('3', 'Wed'), ('4', 'Thu'), ('5', 'Fri'),
